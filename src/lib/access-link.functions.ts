    ...
    const html = `
      <div style="font-family:'DM Sans',Arial,sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#ffffff;color:#0f0f0f;">
        ...
        <p style="font-size:15px;line-height:1.6;margin:0 0 16px;">
          Olá <strong>${full_name}</strong>, um superadmin gerou um novo link de acesso para você.
        </p>
        <p style="font-size:15px;line-height:1.6;margin:0 0 24px;">
          Clique no botão abaixo para definir sua senha e entrar. <strong>O link expira em 1 hora.</strong>
        </p>
        <p style="text-align:center;margin:24px 0;">
          <a href="${link}" style="display:inline-block;background:#c8102e;color:#fff;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:600;">
            Definir senha e acessar
          </a>
        </p>
        <p style="font-size:13px;color:#666;line-height:1.6;margin:24px 0 0;">
          Se o botão não funcionar, copie e cole no navegador:<br/>
          <span style="word-break:break-all;color:#c8102e;">${link}</span>
        </p>
