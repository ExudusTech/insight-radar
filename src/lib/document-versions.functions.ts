...
CANAIS DE ABORDAGEM (canais_obrigatorios): extraia APENAS quando o documento expressar de forma inequívoca a intenção de que o analista USE aquele canal para ABORDAR o concorrente. Exemplos válidos: "abordar via WhatsApp", "entrar em contato pelo Instagram DM", "primeiro contato por email". Exemplos inválidos: o concorrente tem site, o concorrente usa formulário, o concorrente está no Instagram — esses são canais de exposição do concorrente, não de abordagem do analista. Normalize para os valores exatos: "Instagram DM", "WhatsApp", "Email", "Site", "LinkedIn", "Ligação", "Reunião online", "Formulário". Em caso de dúvida, retorne array vazio — o briefing chat confirma com o cliente.

PROFUNDIDADE AUTORIZADA (profundidade_autorizada): identifique até onde o analista pode ir no funil do concorrente. "observacao" = apenas observar/monitorar sem contato. "contato" = primeiro contato/mensagem inicial. "qualificacao" = conversa qualificadora, perguntas de descoberta. "reuniao" = agendar/participar de reunião, call, demo ou videoconferência. Se o documento menciona que o analista pode gravar uma call, fazer uma demo ou participar de reunião online — use "reuniao". "qualificacao" = apenas conversa qualificadora SEM avanço para reunião ou demo. "contratacao" = simular contratação real. Se ambíguo, retorne string vazia.
